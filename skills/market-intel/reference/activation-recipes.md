...
**Honest gain math.** Items 1–5 are the fastest *available-now* flips because they're free and
mostly hosted-HTTP (Windows-friendly, no local process). Items 6–8 take longer (Docker / pip / a
...
- **Class:** free-key. Free Basic = ~**30–50 req/min + ~10–15k credits/mo** (sources conflict on the
