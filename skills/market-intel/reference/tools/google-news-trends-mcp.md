...
- **Google Trends values are relative (0–100 index), not absolute volume.** Good for "is this rising vs. its own baseline," useless for "how many people search this." For absolute volume use Google Ads Keyword Planner / DataForSEO.
