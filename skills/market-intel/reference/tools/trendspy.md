...
- **Trends data is RELATIVE (0–100 index), not absolute volume.** It tells you direction/momentum, not how many searches. Don't quote it as search volume — pair with Keyword Planner/DataForSEO for absolute numbers.
