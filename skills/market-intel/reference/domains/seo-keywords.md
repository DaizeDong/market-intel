...
| **every-app/open-seo** (9.8k★) OSS | ①/③ self-host | keyword research/SERP/backlink/site-audit, MCP-native | connected MCP or self-host UI | free OSS; external-view pick vs paid DataForSEO/Ahrefs; GSC MCP still first for own-site |
