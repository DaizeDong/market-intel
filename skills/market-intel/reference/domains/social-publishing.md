...
| **gitroomhq/postiz-agent** (388★) | ③ | official Postiz agent front-end (`npx skills add`) for 28+ platforms | self-host | lowers agent-vs-API friction over Postiz (388★ at last gh-api check, 2026-08-01) |
