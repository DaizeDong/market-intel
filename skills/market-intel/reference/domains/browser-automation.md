...
|---|---|---|---|
| **browser-use/browser-use** (96k★) | LLM drives the browser via natural-language goals | Python lib; agent calls it | most popular; great for "log in and extract X" |
...
| **unclecode/crawl4ai** (67k★) | LLM-friendly crawler, auto anti-bot (Cloudflare/Akamai) | docker MCP / lib | zero-cost self-host crawl首选 |
...
| **daijro/camoufox** (8.9k★) | anti-fingerprint Firefox build | strongest fingerprint spoofing |
